...
st.markdown("""
<div class="callout">
<strong>Why this reference matters:</strong><br>
This visual is presented as a composite reference image to support early-stage discussion around modular logic, housing productization, interior completion potential, and scalable delivery pathways.
</div>
""", unsafe_allow_html=True)
